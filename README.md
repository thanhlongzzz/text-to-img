...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/text-to-img
```

A live public deployment of this template is available at [https://text-to-img.templates.workers.dev](https://text-to-img.templates.workers.dev)
